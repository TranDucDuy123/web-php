...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 13, 2023 lúc 11:29 AM
...
(14, 7, 32, 1, 130000, 1, 1, 117000),
(15, 8, 32, 1, 130000, 1, 1, 117000),
(16, 8, 16, 1, 592, 1, 1, 532.8),
(17, 8, 18, 1, 7990000, 1, 1, 7191000),
(18, 8, 17, 1, 6990000, 1, 1, 6291000),
(19, 9, 32, 1, 130000, 1, 1, 117000),
(20, 9, 22, 1, 1, 1, 1, 0.9),
(21, 10, 20, 1, 16900, 1, 1, 15210);
...
(12, 2, 2, 'aaa', 'aaa', 'aaa', '159.9', 0000000033, 0000000000, 2, 2, 'Not Active'),
(13, 5, 5, 'Xiao Mi Mix Fold 2', 'XiaomiMixFold2.png', 'Xiaomi MIX Fold 2 là điện thoại màn hình gập thế hệ thứ 2 của công ty và là sản phẩm cạnh tranh với Samsung Galaxy Z Fold 4, OPPO Find N, Vivo Fold X và một vài điện thoại màn hình gập khác trên thị trường hiện nay.', '16005.6', 0000000012, 0000000000, 1, 1, 'Active'),
(14, 5, 5, 'Xiao Mi 12 Pro', 'XiaoMi12Pro.png', 'Xiaomi 12 Pro được Xiaomi trang bị cho chiếc Flagship này tất cả các công nghệ tối tân nhất: Chip mạnh, bộ nhớ siêu nhanh, Camera cực nét và đặc biệt dung lượng Pin cực khủng. ', '1575.6', 0000000013, 0000000000, 1, 1, 'Active'),
...
(16, 2, 2, 'SamSung Z Flip 4', 'SamsungZFlip4.png', 'Nhỏ gọn và tinh tế, Samsung Galaxy Z Flip4 là chiếc smartphone sinh ra dành cho các tín đồ thời trang. Cơ chế gập duyên dáng, bộ màu sắc nhẹ nhàng và loạt chức năng quay chụp sẽ làm say lòng những người yêu cái đẹp.', '592.8', 0000000011, 0000000000, 1, 1, 'Active'),
(17, 2, 2, 'SamSung Galaxy S22', 'Samsunggalaxys22.png', ' Tận hưởng những công nghệ hàng đầu nhà Samsung, Galaxy S22 Plus 5G sẽ cho bạn trải nghiệm đỉnh cao từ thiết kế thời thượng, hiệu năng mạnh mẽ Snapdragon 8 Gen 1 và hệ thống camera đêm chuyên nghiệp nhất từ trước đến nay.', '6990000', 0000000007, 0000000000, 1, 1, 'Active'),
(18, 2, 2, 'SamSung Galaxy S23', 'Samsungalaxy23.jpg', 'Tự hào là điện thoại Galaxy đầu tiên sở hữu cảm biến tuyệt đỉnh 200MP, Samsung Galaxy S23 Ultra đưa người dùng vào không gian nhiếp ảnh tân tiến vượt trội. Sức mạnh còn bùng nổ với vi xử lý Snapdragon mạnh nhất cho cách mạng hiệu năng gaming đột phá. Tất cả được gói gọn trong thiết kế cao cấp và bền vững cho hiện tại và tương lai.', '7990000', 0000000009, 0000000000, 1, 1, 'Active'),
(19, 4, 3, 'Oppo Reno 8', 'OppoReno8.jpg', 'Kế thừa một trong những thương hiệu smartphone được lòng người dùng Việt nhất, OPPO Reno8 Z 5G cho thấy nét cuốn hút riêng với phong cách thiết kế độc đáo, độ hoàn thiện tốt, khả năng hỗ trợ 5G và bộ ba camera sau AI 64MP xứng danh chuyên gia chân dung.', '15600', 0000000012, 0000000000, 1, 1, 'Active'),
(20, 4, 3, 'Oppo Reno 7', 'OppoReno7.jpg', 'OPPO Reno7 Z 5G chinh phục người dùng ngay từ ánh nhìn đầu tiên với thiết kế thời thượng bậc nhất. Bên trong điện thoại còn có nội lực mạnh mẽ từ công nghệ cải tiến, hệ thống camera chân dung tuyệt đỉnh, vi xử lý Snapdragon 695 5G và sạc siêu tốc 33W, giúp bạn sẵn sàng khám phá cuộc sống tràn đầy màu sắc.', '16900', 0000000012, 0000000000, 1, 1, 'Active'),
...
(2, 3, 3, '2023-04-04', 41396400, '256/27 Lãnh Binh Thăng P13 Q11', 'Đang giao', 'MD002', '2023-04-11', '2023-05-13'),
(3, 3, 3, '2023-04-04', 13473000, '256/27 Lãnh Binh Thăng P13 Q11', 'Đã giao', 'MD003', '2023-04-11', '2023-05-13'),
...
(7, 3, 3, '2023-05-09', 225000.9, '256/27 Lãnh Binh Thăng P13 Q11', 'Đã hủy', NULL, '2023-05-16', '2023-05-13'),
(8, 3, 1, '2023-05-16', 13599532.8, '256/27 Lãnh Binh Thăng P13 Q11', 'Đang xử lí', NULL, '2023-05-23', '0000-00-00'),
(9, 3, 1, '2023-05-16', 117000.9, '256/27 Lãnh Binh Thăng P13 Q11', 'Đang xử lí', 'MD006', '2023-05-23', '0000-00-00'),
(10, 3, 1, '2023-06-23', 15210, '256/27 Lãnh Binh Thăng P13 Q11', 'Đang xử lí', 'MD007', '2023-06-30', '0000-00-00');

--
-- Bẫy `donhang`
--
DELIMITER $$
CREATE TRIGGER `tr_donhang_insert` BEFORE INSERT ON `donhang` FOR EACH ROW BEGIN
    DECLARE next_id INT;
    SET next_id = (SELECT COALESCE(MAX(SUBSTRING(MaDH, 3)), 0) + 1 FROM donhang);
    SET NEW.MaDH = CONCAT('MD', LPAD(next_id, 3, '0'));
END
$$
DELIMITER ;
...
(4, 'test', NULL, NULL, '10 Trần Thị Trọng,P15,Q Tân Bình,Tp HCM', '0971912364', 'iuly07raul05@gmail.com'),
(5, 'admin', NULL, NULL, '10 Trần Thị Trọng,P15,Q Tân Bình,Tp HCM', '0971548741', 'iuly07ra666ul05@gmail.com');
...
(12, 'PN002', 1, 3, 12234, '2023-05-16', 2, 'Hoàn thành'),
(15, 'PN003', 1, 3, 369615, '2023-05-16', 5, 'Đã hủy'),
(16, 'PN004', 1, 3, 1, '2023-05-16', 1, 'Hoàn thành'),
(17, 'PN005', 1, 3, 3, '2023-05-16', 3, 'Đang xử lý');
...
CREATE TRIGGER `update_product_quantity_and_price` AFTER UPDATE ON `phieunhap` FOR EACH ROW BEGIN
  IF NEW.trangthai = 'Hoàn thành' THEN
    ...
    SET `dt`.`Soluong` = `dt`.`Soluong` + `ctpn`.`soluong`,
      `dt`.`Giadt` = `ctpn`.`gia` + `ctpn`.`gia`* 0.3
...
(8, 'test', '1231231', 1, 'T', '2023-05-09'),
(9, 'admin', '12121212', 1, 'T', '2023-05-13');
...
--
ALTER TABLE `chitietchucnang`
  MODIFY `ID_chitietchucnang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT cho bảng `chitietdonhang`
--
ALTER TABLE `chitietdonhang`
  MODIFY `id_chitietdonhang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT cho bảng `chitietphieunhap`
--
ALTER TABLE `chitietphieunhap`
  MODIFY `id_chitietphieunhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `dienthoai`
  MODIFY `ID_dienthoai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `thuonghieu`
  MODIFY `id_thuonghieu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
